...
struct VSIReporDeltaCellModel {
    ...
    static func getModel(patientId: Int, patientScanCell: [VSIReportCellModel], questionSurvey : [QuestionsScore]) -> VSIReporDeltaCellModel! {
        ...
        if patientScanCell.count == 1 {
         ...
         guard let calLastLeanValue = Int(scanController.formatLean(lean: abs(last.patientScan.lean))) ,
            ...
            return VSIReporDeltaCellModel(date: "DELTA",
                                          ...
                                          leanValue: "\(abs(calLastLeanValue  -  calFirstLeanValue))º",
                                          sXfXValue: "\(lastDeviationSurveyScore - firstDeviationSurveyScore)",
